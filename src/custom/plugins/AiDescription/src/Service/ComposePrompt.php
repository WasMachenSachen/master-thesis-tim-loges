...
class ComposePrompt
{
    ...
    /**
     * Compose message for generation
     *
     * This method composes a message for generating a wine description based on the given attributes.
     *
